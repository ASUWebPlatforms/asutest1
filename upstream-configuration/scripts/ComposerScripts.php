...
class ComposerScripts {
  ...
  public static function postUpdate(Event $event) {
    ...
    if ($fa_install) {
      ...
      $asuawesome_icon_list = file_get_contents('docroot/themes/webspark/renovation/asuawesome-iconlist.yml');
      // Custom Renovation ASUAwesome icon list.
      $renovation_icon_list = 'docroot/themes/webspark/renovation/renovation.fontawesome.iconlist.yml';
