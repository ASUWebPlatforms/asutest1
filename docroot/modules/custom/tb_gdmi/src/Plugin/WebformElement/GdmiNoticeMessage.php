...
/**
 * Provides a 'gdmi_notice_message' element.
 *
 * @WebformElement(
 *   id = "gdmi_notice_message",
 *   default_key = "gdmi_notice_message",
 *   label = @Translation("GDMI Notice Message"),
 ...
 * )
 */
class GdmiNoticeMessage extends WebformMarkupBase {
