...
class MediaCombinedUploadForm extends FileUploadForm {
  ...
  public function buildInputElement(array $form, FormStateInterface $form_state) {
    ...
    $validators = floatval(\Drupal::VERSION) < 10.2 ? ['media_directories_ui_file_validator' => [$validators_by_media_type]]
    ...
    $validators['file_validate_extensions'] = [$this->mediaDirectoriesUiHelper->getValidExtensions($target_types)];
