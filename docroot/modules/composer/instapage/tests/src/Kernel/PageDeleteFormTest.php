...
/**
 * Tests the PageDeleteForm form.
 *
 * @group instapage
 *
 * @package Drupal\Tests\instapage\Kernel
 */
class PageDeleteFormTest extends KernelTestBase {
   ...
   */
  public function testPageDeleteFormBuild(): void {
    ...
    $form = $this->formBuilder->buildForm(PageDeleteForm::class, $form_state);
    $this->assertNotNull($form);
    $this->assertCount(0, $form_state->getErrors());
    $this->assertArrayHasKey('label', $form);
    $this->assertEquals('Are you sure you want to delete the path and unpublish the page Testing page 2?', $form['label']['#markup']);
   ...
   */
  public function testPageDeleteFormSubmit(): void {
    $this->settingsConfig->set('instapage_user_token', $this->token);
    $this->settingsConfig->set('instapage_user_id', $this->email)->save();
    $this->pagesConfig->set('page_labels', [
      123456 => 'Testing page 1',
    ...
    $this->formBuilder->submitForm(PageDeleteForm::class, $form_state);
